...
<swiper class="swiper card mt-3 " :options="swiperOption">
     <swiper-slide v-for="item in productALL" :key="item.id" class="swiper-slide mb-5
       card__item">
      
            <dl class="card__content">
            <div class="Productimg" ><a href="" @click.prevent="getProduct(item.id)"><img :src="item.imageUrl" class="bg-cover"></a></div>
