  ...
  <div class="my-5 row justify-content-center">
    ...
    <div class="container d-flex header align-items-center text-center">
      ...
      <div class="col">
        ...
        <div v-else class="alert alert-secondary alert-rounded mb-0"  role="alert" >
  2.金流付款
        </div>
      </div>
      <div class="col">
        <div v-if="!order.is_paid" class="alert alert-secondary alert-rounded mb-0" role="alert">
           3.完成
        </div>
      ...
      <table class="table">
        <tbody>
          ...
          <tr>
            <th>付款狀態</th>
            <td>
              <span v-if="!order.is_paid"  class="text-danger payContent">尚未付款</span>
